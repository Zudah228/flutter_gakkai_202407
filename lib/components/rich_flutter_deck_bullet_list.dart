...
///       builder: (context) => RichFlutterDeckBulletList(
///         useSteps: true,
///         items: const [
///           'Bullet point 1',
///           'Bullet point 2',
...
/// }
/// ```
class RichFlutterDeckBulletList extends StatefulWidget {
  ...
  @override
  State<RichFlutterDeckBulletList> createState() =>
      _RichFlutterDeckBulletListState();
}

class _RichFlutterDeckBulletListState extends State<RichFlutterDeckBulletList> {
